...
public class MusicPaneListener extends Listener
{
	...
	//TODO:private JavaFXVideoPlayerLaunchedFromSwing musicChann;
	//TODO:private SceneGenerator geneScene;
	private LeapFrame listenerPane;
	
	public MusicPaneListener(MusicPane musPane, LeapFrame frLeap)
	//TODO:public MusicPaneListener(JavaFXVideoPlayerLaunchedFromSwing musPane, LeapFrame frLeap)
	{
		super();
		musicChann = musPane;
		listenerPane = frLeap;
